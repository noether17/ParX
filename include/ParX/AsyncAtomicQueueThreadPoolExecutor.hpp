...
using AsyncAtomicQueueThreadPoolExecutor = TPE4;

// Template version for testing purposes.
template <std::size_t num_threads>
struct AsyncAtomicQueueThreadPoolTemplateExecutor
    : AsyncAtomicQueueThreadPoolExecutor {
  AsyncAtomicQueueThreadPoolTemplateExecutor()
      : AsyncAtomicQueueThreadPoolExecutor(num_threads) {}
};
}  // namespace ParX
